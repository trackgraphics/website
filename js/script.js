...
$('.scroll').on('click', function( event ) {
  ...
  var h = parseInt($('.navbar').outerHeight()) + parseInt($item.css('margin-top')) + 0;
  $('html, body').animate({
    scrollTop: top - h + 'px'
  }, 800);
...
$( '.list-group-item' ).on( 'click', function(e) {
    ...
    // Actions on content
    $( itemCurrent ).fadeOut( 800, 'swing', function(){
        $( itemSelected ).fadeIn('fast');
    });
});
...
$(function () {
  $('.mytooltip').tooltip();
  $('.mypopover').popover({toggle : 'popover' , trigger : 'click' , placement : 'top' , html : 'true'});
});
...
$('#form').submit(function(event) {
  ...
  .done(function(response) {
    ...
    $('#messaggio h4').text(msgTitleOK);
    $('#messaggio p').text(msgTextOK);
    $('#messaggio').modal();
  })
  ...
  .fail(function(data) {
    ...
    $('#messaggio h4').text(msgTitleNO);
    $('#messaggio p').text(msgTextNO);
    $('#messaggio').modal();
  });// End Ajax.
});
...
function initMap() {
  ...
  var office = {lat: 45.6430529, lng: 13.782718};
  ...
  var info = new google.maps.InfoWindow({
    content:
      "<strong>TRACK Graphics</strong><br/>"+
      "Via Del Muraglione, 24 - 34137 Trieste<br/>" +
      "<a href='tel:+39040350290' title='Chiama TRACK Graphics'>+39 040 350 290</a>"
  });
...
var Grid = (function() {
  ...
  Preview.prototype = {
    create : function() {
      ...
      this.$cta = $( '<p></p>' );
      this.$href = $( '<a class="btn btn-primary btn-lg btn-labeled scroll" href="#" title="Contatta TRACK Graphics"><span class="btn-label">Contattaci</span><i class="fa fa-phone-square"></i></a>' );
      this.$details = $( '<div class="og-details"></div>' ).append( this.$title, this.$description, this.$cta, this.$href );
