<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $body  =    "<p>Richiesta informazioni</p>";
        $body .=    "<h1>" . $formName . "</h1>";
        $body .=    "<p>
                        Hai ricevuto una richiesta informazioni dal sito.<br> 
                        Per motivi di sicurezza il mittente risulta info@trackgraphics.it.<br>
                        Copia e incolla l'indirizzo email " . $email ." per rispondere.
                    </p>";
        $body .=  "<h3>Dettagli di contatto</h3>";
        $body .=  "<ul>";
        $body .=     "<li>Nome: " . $name . "</li>";
        $body .=     "<li>Email: " . $email . "</li>";
        $body .=     "<li>Telefono: " . $phone . "</li>";
        $body .= "</ul>";
        $body .=  "<h3>Testo del messaggio</h3>";
        $body .= "<p>" . $message . "</p>";
        $mail->MsgHTML($body);
